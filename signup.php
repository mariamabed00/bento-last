    ...
    <nav class="navbar navbar-expand-lg py-3">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link text-danger" href="signup.php">Sign Up</a>
              </li>
              <li class="nav-item">
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl -6" id="form-items-child">
          <div class="card">
            <div class="card-body p-5">
              ...
              <form class="signup-form" name="signupform" onsubmit="return validateForm1()" method="POST" action="signup.php">
              <div class="form-outline mb-4">
                  <label for="signup-type" class="form-label">Sign up as a..</label>
              <select id="signup-type" name="signup-type" class="form-control form-control-lg" onchange="location = this.value;">
                <option>User</option>
                <option value="/bento/login.php">Admin</option>
                <option value="/bento/vendor.php">Vendor</option>
                  <option value="/bento/cv.php">Nutritionist</option>
                </select>
          </div>
