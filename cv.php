...
if(isset($_POST['send']))
{
    ...
    $proof = mysqli_real_escape_string($con, $_POST['proof']);
        ...
        $sql = "INSERT INTO nutri (name,email,proof) VALUES ('$name','$email','$proof')";
...
<html>
    <head>
        <title>Sign Up as a Nutritionist</title>
                  ...
                  <div class="col-12 col-md-9 col-lg-7 col-xl -6" id="form-items-child">
                    <div class="card">
                      <div class="card-body p-5">
                        <h2 class="text-uppercase text-center mb-5">Signing up as a nutritionist</h2>
          
                        <form class="signup-form" method="POST" action="cv.php">
                          ...
                          <div class="form-group">
                            <label for="exampleFormControlFile1">Upload subject of proof</label>
